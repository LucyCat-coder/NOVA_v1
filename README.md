...
- [Финальный технический отчёт](./NOVA_v1_FINAL_REPORT.md)
- [Данные, веса и ограничения публикации](./DATA_AND_WEIGHTS.md)
- [Teacher-forcing diagnostic](./reports/sft_teacher_forcing_diagnostic.txt)
- [No-RAG quality audit](./reports/final_quality_audit.txt)
- [English final report](./NOVA_v1_FINAL_REPORT_EN.md)
